...
namespace CarBuddyAPI
{
    ...
    partial void InsertAppFreedBack(AppFreedBack instance);
    partial void UpdateAppFreedBack(AppFreedBack instance);
    partial void DeleteAppFreedBack(AppFreedBack instance);
    #endregion
		
		public CarBuddyDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["CarBuddyDBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<AppFreedBack> AppFreedBacks
		{
			get
			{
				return this.GetTable<AppFreedBack>();
			}
		}
	}
    ...
    partial void OnversionChanged();
			...
			set
			{
				if ((this._UID != value))
				{
					if ((((((((((this._Home.HasLoadedOrAssignedValue || this._OrgJoiner.HasLoadedOrAssignedValue) 
								...
								|| this._RoutePoint.HasLoadedOrAssignedValue) 
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_RoutePoint", Storage="_RoutePoints", ThisKey="UID", OtherKey="UID")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoutePoint_User", Storage="_RoutePoint", ThisKey="UID", OtherKey="UID", IsForeignKey=true)]
    ...
    partial void OnPathIDChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="RoutePoint_User", Storage="_Users", ThisKey="UID", OtherKey="UID")]
		public EntitySet<User> Users
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_RoutePoint", Storage="_User", ThisKey="UID", OtherKey="UID", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.AppFreedBacks")]
	public partial class AppFreedBack : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _DeveloperAnswer;
    ...
    partial void OnFromUIDChanging(int value);
    partial void OnFromUIDChanged();
    partial void OnStarChanging(System.Nullable<byte> value);
    partial void OnStarChanged();
    partial void OnFeedbackChanging(string value);
    partial void OnFeedbackChanged();
    partial void OnDeveloperAnswerChanging(string value);
    partial void OnDeveloperAnswerChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DeveloperAnswer", DbType="NChar(300)")]
		public string DeveloperAnswer
		{
			get
			{
				return this._DeveloperAnswer;
			}
			set
			{
				if ((this._DeveloperAnswer != value))
				{
					this.OnDeveloperAnswerChanging(value);
					this.SendPropertyChanging();
					this._DeveloperAnswer = value;
					this.SendPropertyChanged("DeveloperAnswer");
					this.OnDeveloperAnswerChanged();
				}
			}
		}
